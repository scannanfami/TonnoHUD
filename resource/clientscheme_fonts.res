Scheme
{
	...
	Fonts
	{
		...
		"G_FontHuge"
		{
			"1"
			{
				"name"			"Verdana" [$WINDOWS] // Primary font
				"name"			"Verdana" [!$WINDOWS] // Primary font
				"tall"			"" [$WINDOWS] // Size Huge Primary
				"tall"			"" [!$WINDOWS] // Size Huge Primary
				"weight"		"0"
				"additive"		"0"
				"antialias"		"1"
		...
		"G_FontMedium"
		{
			"1"
			{
				"name"			"Verdana" [$WINDOWS] // Primary font
				"name"			"Verdana" [!$WINDOWS] // Primary font
				"tall"			"24" [$WINDOWS] // Size Medium Primary
				"tall"			"24" [!$WINDOWS] // Size Medium Primary
				"weight"		"0"
				"additive"		"0"
				"antialias"		"1"
		...
		"G_FontSmall"
		{
			"1"
			{
				"name"			"Verdana" [$WINDOWS] // Primary font
				"name"			"Verdana" [!$WINDOWS] // Primary font
				"tall"			"0" [$WINDOWS] // Size Small Primary
				"tall"			"0" [!$WINDOWS] // Size Small Primary
				"weight"		"0"
				"additive"		"0"
				"antialias" 	"1"
		...
		"G_FontTiny"
		{
			"1"
			{
				"name"			"Verdana" [$WINDOWS] // Primary font
				"name"			"Verdana" [!$WINDOWS] // Primary font
				"tall"			"0" [$WINDOWS] // Size Tiny Primary
				"tall"			"0" [!$WINDOWS] // Size Tiny Primary
				"weight"		"0"
				"additive"		"0"
				"antialias" 	"1"
		...
		"G_FontHuge_2"
		{
			"1"
			{
				"name"			"Verdana" [$WINDOWS] // Secondary font
				"name"			"Verdana" [!$WINDOWS] // Secondary font
		...
		"G_FontHealth"
		{
			"1"
			{
				"name"			"Verdana" [$WINDOWS] // Health Font | Primary font
				"name"			"Verdana" [!$WINDOWS] // Health Font | Primary font
				"tall"			"35" // Size Huge Primary - Font Size Health
				"weight"		"0"
				"additive"		"0"
				"antialias"		"1"
			}
		...
		"G_FontAmmo"
		{
			"1"
			{
				"name"			"Verdana" [$WINDOWS] // Ammo Font | Primary font
				"name"			"Verdana" [!$WINDOWS] // Ammo Font | Primary font
				"tall"			"35" // Size Huge Primary - Font Size Ammo
				"weight"		"0"
				"additive"		"0"
				"antialias"		"1"
			}
		...
		"G_FontDamage"
		{
			"1"
			{
				"name"			"Verdana" [$WINDOWS] // Damage font | Primary font
				"name"			"Verdana" [!$WINDOWS] // Damage font | Primary font
				"tall"			"20" // Damage size
				"weight"		"0"
				"additive"		"0"
		...
		"G_FontCritDamage"
		{
			"1"
			{
				"name"			"Verdana" [$WINDOWS] // Crit damage font | Primary font
				"name"			"Verdana" [!$WINDOWS] // Crit damage font | Primary font
		...
		"CloseCaption_Normal"
		{
			"1"
			{
				"name"		"Verdana" [$WINDOWS] // Closed captions font | Secondary font
				"name"		"Verdana" [!$WINDOWS] // Closed captions font | Secondary font
	...
	CustomFontFiles
	{
		...
		"4" 
		{
			"font" "resource/VerdanaSecondary.ttf"
			"name" "Verdana Secondary"
			"russian"
			{
				"range" "0x0000 0xFFFF"
		...
		"5" 
		{
			"font" "resource/VerdanaProfessor.ttf"
			"name" "Verdana Professor"
			"russian"
			{
				"range" "0x0000 0x00FF"
		...
		"6" 
		{
			"font" "resource/VerdanaBuild.ttf"
			"name" "Verdana"
			"russian"
			{
				"range" "0x0000 0xFFFF"
