Scheme
{
	...
	Colors
	{
		...
		"G_Highlight"			"0 0 0 255" // Highlight color
		"G_White"				"255 255 255 255"
		"G_Black"				"0 0 0 255"
		"G_Red"					"230 0 0 255"
		"G_Shadow"				"114 109 109 189" // Shadow color
		"G_LightShadow"			"0 0 0 110"
		"G_Heal"				"13 217 253 255" // Heal color
		...
		"G_PanelBg"				"0 0 0 255" // Panel color
		...
		"G_LowHealthValue"		"250 189 0 255" // Low health value color
		"G_AmmoClipValue"		"244 237 237 255" // Ammo in clip value color
		"G_AmmoReserveValue"	"199 185 185 255" // Ammo in reserve value color
		"G_LowAmmo"				"240 123 15 255" // Low ammo color
		"G_MetalValue"			"255 255 255 255" // Metal color
		"G_MetalIcon"			"210 210 210 255" // Metal icon color
		"G_HeadsValue"			"255 255 255 255" // Heads value color
		"G_HeadsLabel"			"0 235 247 255" // Heads value icon color
		"G_KillstreakValue"		"253 255 0 255" // Killstreak value color
		"G_KillstreakIcon"		"255 19 0 255" // Killstreak icon color
		"G_StickyColor"					"255 255 255 255" // Stickybomb color
		"G_StickyIconColor"				"11 124 44 255" // Stickybomb icon color
		...
		"G_TargetHealthValueShadow" 	"255 255 255 0" // Target ID health value shadow color
		"G_Killfeed_Base"			"0 0 0 196" // Killfeed Base color
		"G_Killfeed_Local"			"255 255 255 112" // Killfeed Local color
		"G_CenteredMetalBg"			"57 57 57 120" // Centered metal background color
		...
		"G_OuterBorder"				"0 255 25 255" // Outer border color
		...
		"G_MainMenuOverlay"			"199 0 255 0" // Main Menu overlay color
		"G_MainMenuPanel"			"255 255 255 0" // Main Menu panel color
		"G_MainMenuButton"			"0 0 0 255" // Main Menu button color
		"G_MainMenuButtonHover"		"85 85 85 247" // Main Menu hovered button color
		"G_MainMenuButtonFg"		"19 255 0 255" // Main Menu button text color
		"G_MainMenuButtonHoverFg"	"243 255 0 255" // Main Menu hovered button text color
		"G_MainMenuShader" 			"0 255 6 0" // Main Menu shader color
		...
		"G_MenuText"				"0 255 62 255" // Menu text color
		"G_InputText"				"0 25 255 255" // Input text color
		"G_DimmInputText"			"0 25 255 100" // Dimm Input text color
		"G_DimmMenuText"			"0 255 62 120" // Dimm Menu text color
		"G_ItemDescriptionPanelBg"	"24 22 20 255" // Item description panel bg
		"G_ButtonBg"				"0 0 0 255" // Button bg color
		"G_ButtonText"				"0 255 6 255" // Button text color
		"G_ButtonHoverBg"			"0 0 0 255" // Button hover bg color
		"G_ButtonHoverText"			"50 255 0 255" // Button hover text color
		"G_ButtonSelectedBg"		"68 62 62 133" // Button selected bg color
		"G_ButtonSelectedText"		"218 255 0 255" // Button selected text color
		...
		"G_XPBar"					"250 29 234 255" // XP Bar color
		...
		"TFOrange"			"0 0 0 255" // Highlight color
	...
	BaseSettings
	{
		...
		Slider.NobColor				"0 0 0 255" // Highlight color
		Slider.TextColor			"0 255 62 255" // Menu text color
		Slider.TrackColor			"0 255 62 255" // Menu text color
		Slider.DisabledTextColor1	"0 255 62 120" // Dimm Menu text color
		Slider.DisabledTextColor2	"0 255 62 120" // Dimm Menu text color
